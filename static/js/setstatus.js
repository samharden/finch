...
// $('body').on('click', '#clearassigneduser', function (e) {
//     e.preventDefault()
//     $('#assigned_users').val('')
//     $('#selected-assigned-users').val('')
// });
$('body').on('click', '#select-assigned-user-model .cell .username', function (e) {
    e.preventDefault();
    // console.log($(this))
    // if($('#selected-assigned-users').length<1) {
    //  $('.assigned_users_error').before('<div id="selected-assigned-users"></div>')
